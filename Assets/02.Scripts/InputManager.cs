...
public class InputManager
{
    ...
    public void OnUpdate()
    {
        ...
        _mouseBtnPressed = Input.GetMouseButton(0);
        ...
        {        
            if (!_pressed)
            {
                ...
                if (Physics.Raycast(ray, out rayHit, Mathf.Infinity, layerUnit))
                {
                    if (Player.Instance.selectedUnits.Count > 0)
                    {
                        ...
                        {
                            Player.Instance.selectedUnits[i].arrivePos = moveToPos;
                            Player.Instance.selectedUnits[i].DoMove = true;
                        }
                    }
                    //if (Player.Instance.selectedUnit != null)
                    //{
